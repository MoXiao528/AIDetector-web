<template>
  <section id="pricing" class="py-24">
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <div class="max-w-3xl">
        <h2 class="section-title">灵活定价，适配不同团队规模</h2>
        ...
        >
          ...
          <div class="relative flex h-full flex-col justify-between">
            <div>
              ...
              <p class="mt-6 text-3xl font-bold text-slate-900">{{ plan.price }}<span class="text-base font-medium text-slate-500"> / 月</span></p>
