  ...
  <header class="sticky top-0 z-40 border-b border-slate-200/60 bg-white/80 backdrop-blur">
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        ...
        <nav v-if="showMarketingNav" class="hidden items-center space-x-8 text-sm font-medium text-slate-600 md:flex">
        ...
        <div v-if="isMarketing || isAuth" class="hidden items-center md:flex">
          <button
            type="button"
    ...
    <transition name="fade">
      <div v-if="isMobileMenuOpen" class="md:hidden">
        <div class="mx-auto mt-2 max-w-6xl space-y-3 rounded-3xl border border-slate-200 bg-white/95 p-4 shadow-lg">
