          ...
          <div class="space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
              <div
                ...
                :key="option.key"
                class="flex flex-col items-center justify-center gap-2 rounded-xl border border-primary-500 bg-primary-50 px-3 py-4 text-xs font-semibold text-primary-700 ring-1 ring-primary-500"
              >
...
const functionOptions = computed(() => [{ key: 'scan', label: t('scan.functions.scan'), icon: ShieldCheckIcon }]);
